...
export function VercelUnderAttackMode({ projectId, onClose, rule, zoneConfigs = [], rules = [], projects = [] }: VercelUnderAttackModeProps) {
    ...
    const vercelUnderAttackTemplates = (rules || []).filter(r => r.type === "vercel_under_attack_mode");
    ...
    return (
        ...
        >
            <form onSubmit={handleSubmit} className="px-6 py-5 space-y-5">
                ...
                {vercelUnderAttackTemplates.length > 0 && (
                    <div className="bg-gradient-to-r from-rose-50/50 to-pink-50/50 border border-rose-100 rounded-md p-4 transition-all hover:shadow-sm">
                        ...
                        <select
                            onChange={(e) => {
                                const selectedRule = vercelUnderAttackTemplates.find(r => r.id === e.target.value);
                                if (selectedRule) {
                        ...
                        >
                            ...
                            {vercelUnderAttackTemplates.map((r: any) => {
                        ...
                        <p className="mt-1.5 text-[10px] text-rose-700 font-medium">
                            Quickly copy the request threshold, time window, rule name, traffic source, auto-off thresholds, and notification settings from another project's Attack Mode rule.
                        </p>
                    </div>
                )}
                ...
                <div className="bg-gray-50/50 border border-gray-100 rounded-md p-4 transition-all hover:bg-white hover:shadow-sm">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            placeholder='e.g. "Vercel Auto Attack Mode"'
                            required
                            className={inputCls}
                        />
