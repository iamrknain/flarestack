...
interface VercelUnderAttackModeProps {
    zoneId: string; // Used generically by RULE_REGISTRY, represents projectId here
    onClose: () => void;
...
export function VercelUnderAttackMode({ zoneId: projectId, onClose, config }: VercelUnderAttackModeProps) {
            ...
            <form onSubmit={handleSubmit} className="px-6 py-5 space-y-5">
                ...
                <div className="bg-gray-50/50 border border-gray-100 rounded-md p-4 transition-all hover:bg-white hover:shadow-sm">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" placeholder='e.g. "Vercel Auto Attack Mode"' required className={inputCls} />
