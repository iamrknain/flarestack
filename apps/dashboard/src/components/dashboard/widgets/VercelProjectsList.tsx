...
export function VercelProjectsList({
    ...
    return (
        <div className="lg:col-span-2 bg-white border border-gray-200 rounded-md shadow-sm overflow-hidden mt-6">
            ...
            <div className="divide-y divide-gray-100">
                {projects.length === 0 ? (
                    <div className="py-16 flex flex-col items-center justify-center text-center gap-3">
                        ...
                        <p className="text-black font-medium text-sm">No Vercel projects registered yet.</p>
                    ...
                    projects.map((project) => {
                        ...
                        return (
                            <div key={project.id} className="p-6 border-b border-gray-100 last:border-0 bg-gradient-to-br from-white to-gray-50/30">
                                ...
                                {/* Webhook copy widget */}
                                <div className="bg-slate-50 border border-slate-200/60 rounded-md p-3.5 mt-4 text-xs">
                                    <div className="flex justify-between items-center mb-1">
                                        <span className="font-bold text-slate-700 uppercase tracking-tight">Vercel Log Drain Webhook</span>
                                        <span className="text-[10px] text-emerald-600 font-bold uppercase tracking-wider bg-emerald-50 px-1.5 py-0.5 rounded-md border border-emerald-100">Direct Ingestion</span>
                                    </div>
                                    <p className="text-slate-500 font-medium leading-relaxed mb-2">
                                        Configure an HTTP Log Drain in your Vercel project pointing to this URL to feed real-time traffic statistics:
                                    </p>
                                    <div className="flex items-center gap-2">
                                        <code className="bg-slate-100 border border-slate-200/80 px-2.5 py-1.5 rounded-md font-mono text-[11px] text-slate-800 flex-1 select-all break-all leading-tight">
